...
class Thesis {
    ...
    initRenderer() {
        ...
        this.loader.load('static/model/test.glb',
            (gltf)=>{
        ...
        this.camera = new THREE.PerspectiveCamera(90, window.innerWidth / window.innerHeight, .01, 300);
